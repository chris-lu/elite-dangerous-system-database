    ...
    def insert_system(self, cur, system_data: Dict[str, Any]):
        ...
        cur.execute("""
            INSERT INTO systems (
                ...
                controlling_faction_name = EXCLUDED.controlling_faction_name,
                controlling_faction_allegiance = EXCLUDED.controlling_faction_allegiance,
                controlling_faction_government = EXCLUDED.controlling_faction_government,
                controlling_faction_is_player = EXCLUDED.controlling_faction_is_player,
        ...
        try:
            ...
            cur.execute("""
                INSERT INTO bodies (
                    ...
                    gravity, surface_pressure,surface_temperature,
                    earth_masses, radius, spectral_class, luminosity, absolute_magnitude, volcanism_type, atmosphere_type, atmosphere_composition, terraforming_state, solid_composition, materials, 
                    ...
                    volcanism_type = EXCLUDED.volcanism_type,
                    ...
                    solid_composition = EXCLUDED.solid_composition,
            ...
            """, (
                ...
                json.dumps(body_data.get('atmosphereComposition', {}), cls=DecimalEncoder, separators=(',', ':')),
                body_data.get('terraformingState'),
                json.dumps(body_data.get('solidComposition', {}), cls=DecimalEncoder, separators=(',', ':')),
                json.dumps(body_data.get('materials', {}), cls=DecimalEncoder, separators=(',', ':')),
